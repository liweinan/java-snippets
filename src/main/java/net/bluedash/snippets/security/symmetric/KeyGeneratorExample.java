...
public class KeyGeneratorExample {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("ctLength: " + ctLength);
        ...
        System.out.println("(before doFinal) plain : " + Utils.toHex(plainText, ptLength)
                + " bytes: " + ptLength);
        ptLength += cipher.doFinal(plainText, ptLength);
        System.out.println("(after  doFinal) plain : " + Utils.toHex(plainText, ptLength)
                + " bytes: " + ptLength);
    }
}